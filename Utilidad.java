...
public class Utilidad {
    ...
    public Boolean enviarCorreo(Trabajador trabajador) {
        ...
        try{
            ...
            String[] to = { trabajador.getDireccion(), "progwebufps@gmail.com" };
            ...
            mensajeHtml += "<b>De: </b>" + trabajador.getNombre() + "<br>";
            mensajeHtml += "<b>Email: </b>" + trabajador.getDireccion() + "<br>";
            mensajeHtml += "<b>Sitio: </b> www.ufps.edu.co <br>";
            mensajeHtml += "<b>Trabajando con el envío de correos</b><br>";
